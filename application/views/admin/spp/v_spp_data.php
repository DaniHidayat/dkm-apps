        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Spp</h3><br>
              <?php  echo $this->session->flashdata('msg'); ?>
              <?php  echo $this->session->flashdata('succes'); ?>
           <?php $tbl_spp_id=$this->db->query("SELECT * FROM tbl_spp ORDER BY id_spp DESC LIMIT 1")->row();?>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo site_url('admin/Main_admin/tambah_spp') ?> " method="post" enctype="multipart/form-data">
              <div class="box-body">
          
               <input type="hidden" name="id_spp"  value="<?php echo $tbl_spp_id->id_spp+1 ?>">
                 <div class="form-group">
                  <label for="exampleInputAlamat1">Tahun </label>
                  <input type="text" class="form-control"name="tahun" placeholder="Masukan Tahun" value="<?php echo $tbl_spp_id->tahun+1 ?>" readonly>
                </div>
                 <div class="input-group">
                
                   <span class="input-group-addon"><b>Rp</b></span>
                  <input type="number" class="form-control" name="nominal" placeholder="Masukan Nominal" required>
                </div>
                <br>
