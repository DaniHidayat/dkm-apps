      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo site_url('admin/Main_admin/tambah_siswa') ?> " method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputNama1">NISN </label>
                  <input type="text" class="form-control" name="nisn" id="exampleInputNama1"  placeholder="NISN " required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">NIS  </label>
                  <input type="text" class="form-control" name="nis" id="exampleInputEmail1"  placeholder="NIS" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="exampleInputTelp1">KELAS </label>
                      ...
                      <?php foreach($tbl_kelas->result() as $k) : ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="no_telp" id="exampleInputEmail1"  placeholder="NO TELEPON" required>
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">ALAMAT  </label>
                  <textarea style="width:200px; height: 100px;" type="text" class="form-control" name="alamat" id="exampleInputEmail1"  placeholder="ALAMAT" required></textarea> 
                </div>
                  <div class="form-group">
                  <label for="exampleInputTelp1">SPP TAHUN </label>
                            <select name="id_spp" class="form-control" style="width:220px;" required>
                     <?php foreach ($tbl_spp->result() as $s ) :?>
          <option value="<?php echo $s->id_spp; ?>"><?php echo $s->tahun; ?></option>
        <?php endforeach;?>
                            </select>
