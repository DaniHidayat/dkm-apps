...
<?php $this->load->view('includ/v_menu'); ?>
 ...
 <!-- Left side column. contains the logo and sidebar -->
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo site_url('admin/Main_admin/edit_petugas') ?> " method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputNama1">Nama Petugas </label>
                  <input type="hidden" name="id_petugas"  value="<?php echo $u->id_petugas;?>">
                  <input type="text" class="form-control" name="nama_petugas" value="<?php echo $u->nama_petugas;?>"id="exampleInputNama1"  placeholder="Nama " required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Username  </label>
                  <input type="text" class="form-control" name="username" id="exampleInputEmail1"value="<?php echo $u->username;?>"  placeholder="Username" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputAlamat1">Password </label>
                  <input type="text" class="form-control" name="password" id="exampleInputAlamat1"  placeholder="Password" >
                </div>
                <div class="form-group">
                  <label for="exampleInputAlamat1">Ulangi Password </label>
                  <input type="text" class="form-control" name="password2" id="exampleInputAlamat1"  placeholder="Password" >
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 - 2020 <a href="#"></a></strong> All rights reserved.
  </footer>
