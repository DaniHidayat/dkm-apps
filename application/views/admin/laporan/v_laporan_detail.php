  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
                          ...
                          <!-- /.box-header -->
            <form role="form" action="<?php echo site_url('admin/Main_admin/form_laporan') ?> " method="GET" >
              <div class="box-body">
          
               <label for="exampleInputAlamat1">Dari Tanggal </label>
                 <div class="input-group">
                   <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <input type="date" class="form-control" name="tg1" placeholder="Masukan Nominal" required>
                </div>
                <br>
                <label for="exampleInputAlamat1">Sampai Tanggal </label>
                 <div class="input-group">
                   ...
                   <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <input type="date" class="form-control" name="tgl2" placeholder="Masukan Nominal" required>
                </div>
                <br>
    ...
    <button type="submit" class="btn btn-primary">Simpan</button>
        ...
        <div class="col-md-9">
         ...
         <a href="<?php echo base_url('admin/Main_admin/cetak_laporan?tgl1='.$this->input->get('tgl1').'&tgl2='.$this->input->get('tgl2').'');?>" class="btn btn-success" title=""><i class="fa fa-print"></i></a>
               <thead>
                    <tr>
